...
sample1 = Scale(root, from_=-10, to=10,length=600, orient=HORIZONTAL,variable=var)
frequency1 = Scale(root, from_=-10, to=10,length=600, orient=HORIZONTAL,variable=var2)

sample1.pack()
button = Button(root, text='Show',command=sel)
button.pack()
frequency1.pack()
button2 = Button(root, text='Show',command=sel2)
button2.pack()
label = Label(root)
label.pack()
